...
/*
	...
	ID         net.ID     `json:"id"`          // authenticated identifier
...
// 	_, err := net.NewNetAddressString(net.IDAddressString(info.ID, info.ListenAddr))
// 	return err
// }
...
// 	netAddr, err := NewNetAddressString(net.IDAddressString(info.ID, info.ListenAddr))
// 	if err != nil {
// 		switch err.(type) {
