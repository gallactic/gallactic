...
func request_Network_GetPeers_0(ctx context.Context, marshaler runtime.Marshaler, client NetworkClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty1
	var metadata runtime.ServerMetadata
...
func RegisterNetworkHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NetworkClient) error {
	...
	mux.Handle("GET", pattern_Network_GetPeers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_Network_GetPeers_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Network_GetPeers_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Network_GetNetworkInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"NetworkInfo"}, ""))

	pattern_Network_GetPeers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"Peers"}, ""))
)

var (
	forward_Network_GetNetworkInfo_0 = runtime.ForwardResponseMessage

	forward_Network_GetPeers_0 = runtime.ForwardResponseMessage
)
