...
func (*TransactRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_c614f469fa2b11c5, []int{0}
}
...
func (*ReceiptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_c614f469fa2b11c5, []int{1}
}
...
func (*UnconfirmedTxsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_c614f469fa2b11c5, []int{2}
}
...
func (*UnconfirmTxsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_c614f469fa2b11c5, []int{3}
}
...
func init() {
	proto.RegisterFile("rpc/grpc/proto3/transaction.proto", fileDescriptor_transaction_c614f469fa2b11c5)
}
func init() {
	golang_proto.RegisterFile("rpc/grpc/proto3/transaction.proto", fileDescriptor_transaction_c614f469fa2b11c5)
}

var fileDescriptor_transaction_c614f469fa2b11c5 = []byte{
	// 417 bytes of a gzipped FileDescriptorProto
	,
}
