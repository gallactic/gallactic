...
func (*Empty2) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_9309062781a99715, []int{0}
}
...
func (*TransactRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_9309062781a99715, []int{1}
}
...
func (*ReceiptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_9309062781a99715, []int{2}
}
...
func (*UnconfirmedTxsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_9309062781a99715, []int{3}
}
...
func (*UnconfirmTxsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_9309062781a99715, []int{4}
}
...
func init() {
	proto.RegisterFile("rpc/grpc/proto3/transaction.proto", fileDescriptor_transaction_9309062781a99715)
}
func init() {
	golang_proto.RegisterFile("rpc/grpc/proto3/transaction.proto", fileDescriptor_transaction_9309062781a99715)
}

var fileDescriptor_transaction_9309062781a99715 = []byte{
